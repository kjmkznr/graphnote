...
export function makeCellHeader(kindLabel: string, cellId: string, store: ScrapbookStore): HTMLElement {
...
export function makeMemoSection(cellId: string, initialMemo: string | undefined, store: ScrapbookStore): HTMLElement {
