...
describe("validatePropertyValue", () => {
  ...
  it("validates url", () => {
    expect(validatePropertyValue("url", "https://example.com").valid).toBe(
      true,
    );
    expect(validatePropertyValue("url", "http://foo.bar/path?q=1").valid).toBe(
      true,
    );
    ...
    expect(validatePropertyValue("url", "javascript:alert(1)").valid).toBe(
      true,
    );
  });
...
describe("parsePropertyValue", () => {
  ...
  it("returns string for string/url/email/date types", () => {
    ...
    expect(parsePropertyValue("url", "https://example.com")).toBe(
      "https://example.com",
    );
