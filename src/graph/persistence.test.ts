...
import { saveGraph, loadGraph, clearSaved, migrateFromLocalStorage, type IAsyncStorage } from './persistence';
...
describe('persistence', () => {
  ...
  it('migrateFromLocalStorage should move data from localStorage to IAsyncStorage', async () => {
    const localStorageMock: Record<string, string> = { 'graphnote:v1': '{"version":1,"nodes":[],"edges":[],"positions":{}}' };
